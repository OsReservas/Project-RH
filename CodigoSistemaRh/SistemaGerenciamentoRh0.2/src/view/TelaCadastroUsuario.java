...
public class TelaCadastroUsuario extends JFrame {
	...
	public TelaCadastroUsuario(){
		...
		txtNome.setFont(new Font("Poppins", Font.PLAIN, 13));
		...
		txtCpf.setFont(new Font("Poppins", Font.PLAIN, 13));
		txtCpf.setBounds(145, 124, 259, 20);
		panel.add(txtCpf);
		...
		txtEmail.setFont(new Font("Poppins", Font.PLAIN, 13));
		...
		txtSenha.setFont(new Font("Poppins", Font.PLAIN, 13));
		...
		comAcesso.setFont(new Font("Poppins", Font.PLAIN, 13));
		...
		textField_2.setFont(new Font("Poppins", Font.PLAIN, 13));
		...
		btnNewButton_3.setFont(new Font("Poppins", Font.PLAIN, 14));
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnNewButton_3.setBounds(507, 25, 110, 25);
		...
		tblUsuario.setFont(new Font("Poppins", Font.PLAIN, 11));
		...
		tblUsuario.getColumnModel().getColumn(3).setPreferredWidth(146);
		tblUsuario.getColumnModel().getColumn(4).setPreferredWidth(55);
		tblUsuario.getColumnModel().getColumn(5).setPreferredWidth(46);
		scrollPane.setViewportView(tblUsuario);
		
		JButton btnNovo = new JButton("Novo");
		btnNovo.setForeground(Color.WHITE);
		btnNovo.setBackground(new Color(255, 165, 0));
		btnNovo.setFont(new Font("Poppins", Font.PLAIN, 14));
		...
		btnNovo.setBounds(10, 470, 110, 25);
		panel_1.add(btnNovo);
		...
		btnEditar.setBounds(171, 470, 110, 25);
		panel_1.add(btnEditar);
		
		JButton btnExcluir = new JButton("Excluir");
		btnExcluir.setForeground(Color.WHITE);
		btnExcluir.setBackground(new Color(255, 165, 0));
		btnExcluir.setFont(new Font("Poppins", Font.PLAIN, 14));
		...
		btnExcluir.setBounds(330, 470, 110, 25);
		...
		btnBuscartudo.setFont(new Font("Poppins", Font.PLAIN, 14));
		...
		btnBuscartudo.setBounds(497, 470, 120, 25);
		...
		lblNewLabel_8.setIcon(new ImageIcon("C:\\Users\\marce\\Downloads\\SistemaGerenciamentoRh0.1\\src\\images\\administrator.png"));
		...
		lblNewLabel_9.setIcon(new ImageIcon("C:\\Users\\marce\\Downloads\\SistemaGerenciamentoRh0.1\\src\\images\\logo-one .png"));
