...
public class TelaLoguin extends JFrame {
	...
	public TelaLoguin() {
		...
		txtEmail.setFont(new Font("Poppins", Font.PLAIN, 11));
		...
		txtSenha.setFont(new Font("Poppins", Font.PLAIN, 11));
		txtSenha.setBounds(142, 267, 288, 20);
		panel.add(txtSenha);
		
		JButton btnEntrar = new JButton("Entrar");
		btnEntrar.setFont(new Font("Poppins", Font.PLAIN, 14));
		...
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\marce\\Downloads\\SistemaGerenciamentoRh0.1\\src\\images\\user.png"));
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\marce\\Downloads\\SistemaGerenciamentoRh0.1\\src\\images\\Bem-vindo(a)!.png"));
