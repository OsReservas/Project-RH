...
public class TelaLoguin extends JFrame {
	...
	public TelaLoguin() {
		...
		comAtivo.setBounds(142, 313, 46, 22);
		panel.add(comAtivo);
		...
		lblNewLabel_2.setBounds(198, 466, 178, 14);
		...
		lblNewLabel_4.setBounds(171, 141, 220, 14);
		panel.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_5.setIcon(new ImageIcon(TelaLoguin.class.getResource("/images/user.png")));
		lblNewLabel_5.setBounds(125, 125, 36, 40);
		panel.add(lblNewLabel_5);
		
		JButton btnNewButton = new JButton("Criar uma conta");
		btnNewButton.setBounds(268, 84, 109, 23);
