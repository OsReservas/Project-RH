...
public class TelaCadastroCandidato extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCadastroCandidato frame = new TelaCadastroCandidato();
	...
	public TelaCadastroCandidato() {
		...
		lblNewLabel.setBounds(70, 56, 64, 14);
		panel_3.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Data Nascimento: ");
		lblNewLabel_1.setBounds(70, 93, 46, 14);
		...
		btnCadastrar.setBounds(225, 481, 89, 23);
		panel_3.add(btnCadastrar);
		
		txtNome = new JTextField();
		txtNome.setBounds(163, 53, 86, 20);
		panel_3.add(txtNome);
		...
		comLogadouro.setBounds(436, 373, 30, 22);
		...
		btnNewButton_2.setBounds(377, 481, 89, 23);
