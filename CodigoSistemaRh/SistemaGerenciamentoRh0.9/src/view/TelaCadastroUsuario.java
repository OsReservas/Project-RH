...
public class TelaCadastroUsuario extends JFrame {
	...
	public TelaCadastroUsuario(Usuario u) throws ParseException{
		...
		comAcesso.setBounds(151, 294, 72, 22);
		...
		lblAtivo.setBounds(35, 336, 83, 14);
		panel.add(lblAtivo);
		...
		comAtivo.setBounds(151, 332, 72, 22);
		panel.add(comAtivo);
		...
		lblNewLabel_11.setBounds(25, 245, 95, 14);
		...
		btnNewButton.setBounds(706, 336, 166, 23);
		contentPane.add(btnNewButton);
		
		JLabel lblNewLabel_10 = new JLabel("Usuaio: ");
		lblNewLabel_10.setBounds(685, 57, 46, 14);
		contentPane.add(lblNewLabel_10);
		
		JLabel lblNome = new JLabel("");
		lblNome.setBounds(769, 57, 103, 14);
