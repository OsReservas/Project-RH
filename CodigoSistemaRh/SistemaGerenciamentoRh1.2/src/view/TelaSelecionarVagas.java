...
public class TelaSelecionarVagas extends JFrame {
	...
	public void carregarAplicado() {
		...
		for(Aplicado a : list) {
			tabela.addRow(new Object[] {a.getIdAplicado(),a.getVaga().getId(), a.getCandidato().getIdCandidato(), 
			a.getData()});
	}
	...
	public TelaSelecionarVagas(Usuario u, Candidato candidato) {
		...
		lblNewLabel.setBounds(562, 47, 46, 14);
		...
		tblAplicado.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "ID Vaga", "ID Candidato", "Data/Hora"
			}
		));
