...
public class TelaCadastroFormaCurso extends JFrame {
	 ...
	 */
	public TelaCadastroFormaCurso(Usuario u, Candidato candidato) throws ParseException {
		...
		btnAvancar1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TelaCadastroExperiencia tela;
				try {
					tela = new TelaCadastroExperiencia(u, candidato);
		...
		btnFormacao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SelecionarFormacao selecionarformacao = new SelecionarFormacao(candidato);
				selecionarformacao.setVisible(true);
				
				Formacao f = new Formacao(); 
				f =selecionarformacao.getFormacao();
				txtNome.setText(f.getNomeFormacao());
		...
		btnNewButton_3.setBounds(519, 360, 89, 23);
