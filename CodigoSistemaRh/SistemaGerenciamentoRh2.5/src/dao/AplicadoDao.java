...
public List <Aplicado> buscarAplicadoEspecifico(String informacao){
	//Colocar ORDER BY de de acordo com a preferencia do cleinte
	String sql = "SELECT * FROM aplicado where idvaga like '%?%' or titulovaga like '%?%'";
