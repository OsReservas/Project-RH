...
public class UsuarioDao {
	...
	public List <Usuario> buscarUsuario(){
		...
		String sql = "select id,nome, cpf, email, senha, acesso, ativo from usuario where acesso = 'Rh' or acesso = 'Admin'";
	...
	public Usuario Loguin(String email, String senha) {
				...
				String sql = "SELECT * FROM usuario WHERE email = ? and senha = MD5(?) and ativo = 'SIM'";
