...
public List <Usuario> buscarCandidatoUsuario(int idcandidato){
	//Colocar ORDER BY de de acordo com a preferencia do cleinte
	String sql = "SELECT usuario.nome, usuario.cpf, usuario.email FROM usuario INNER JOIN candidato ON usuario.id = candidato.idusuario WHERE candidato.idcandidato = ?";
