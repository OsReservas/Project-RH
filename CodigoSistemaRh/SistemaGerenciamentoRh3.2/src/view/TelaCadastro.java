...
public class TelaCadastro extends JFrame {
	...
	private JTextField textPesAplicado;
	...
	public void carregarAplicadoEspecifico(int id) {
		AplicadoDao aplicadodao = new AplicadoDao();
		List <Aplicado> list = aplicadodao.buscarAplicadoVagaPorId(id);
		DefaultTableModel tabela = (DefaultTableModel) tblAplicado.getModel();
		tabela.setRowCount(0);
		for(Aplicado a : list) {
			tabela.addRow(new Object[] {a.getIdAplicado(),a.getVaga().getId(), a.getVaga().getTitulo() ,a.getCandidato().getIdCandidato(),
	...
	public TelaCadastro(Usuario u) throws ParseException {
		...
		lblNewLabel_1.setBounds(93, 87, 47, 14);
		...
		lblNewLabel_4.setBounds(83, 207, 60, 14);
		...
		lblNewLabel_5.setBounds(85, 247, 59, 14);
		...
		lblNewLabel_6.setBounds(15, 287, 132, 14);
		...
		txtBuscaTitulo.setBackground(new Color(176, 224, 230));
		txtBuscaTitulo.setFont(new Font("Poppins", Font.PLAIN, 12));
		txtBuscaTitulo.setBounds(123, 30, 355, 20);
		...
		scrollPane.setBounds(11, 81, 607, 310);
		...
		btnNovo.setBounds(11, 470, 135, 30);
		panel_1.add(btnNovo);
		...
		btnEditar.setBounds(222, 470, 135, 30);
		...
		btnExcluir.setBounds(436, 470, 135, 30);
		...
		btnNewButton.setBounds(488, 25, 130, 30);
		panel_1.add(btnNewButton);
		
		JPanel panel_2 = new JPanel();
		panel_2.setBackground(new Color(255, 255, 255));
		tabbedPane.addTab("Gerenciamento dos Candidatos", null, panel_2, null);
		panel_2.setLayout(null);
		
		JLabel lblNewLabel_12 = new JLabel("Buscar Candidaturas:");
		lblNewLabel_12.setFont(new Font("Poppins", Font.PLAIN, 12));
		lblNewLabel_12.setBounds(10, 27, 133, 14);
		panel_2.add(lblNewLabel_12);
		
		textPesAplicado = new JTextField();
		textPesAplicado.setBackground(new Color(176, 224, 230));
		textPesAplicado.setFont(new Font("Poppins", Font.PLAIN, 12));
		textPesAplicado.setBounds(153, 24, 313, 20);
		panel_2.add(textPesAplicado);
		textPesAplicado.setColumns(10);
		...
		btnNewButton_1.setIcon(new ImageIcon(TelaCadastro.class.getResource("/images/search.png")));
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				carregarAplicadoEspecifico(Integer.parseInt(textPesAplicado.getText()));
				
			}
		});
		btnNewButton_1.setBounds(476, 19, 130, 30);
		panel_2.add(btnNewButton_1);
		
		JTextPane txtObs = new JTextPane();
		txtObs.setBackground(new Color(176, 224, 230));
		txtObs.setBorder(new LineBorder(new Color(0, 0, 0)));
		txtObs.setFont(new Font("Poppins", Font.PLAIN, 12));
		txtObs.setBounds(22, 314, 339, 113);
		panel_2.add(txtObs);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setFont(new Font("Poppins Light", Font.PLAIN, 12));
		scrollPane_1.setBounds(10, 79, 608, 178);
		panel_2.add(scrollPane_1);
		
		tblAplicado = new JTable();
		tblAplicado.setBackground(new Color(176, 224, 230));
		tblAplicado.setForeground(new Color(0, 0, 0));
		...
		lblNewLabel_13.setBounds(22, 290, 175, 14);
		panel_2.add(lblNewLabel_13);
		
		
		JButton btnNewButton_2 = new JButton("Adicionar Obs");
		btnNewButton_2.setIcon(new ImageIcon(TelaCadastro.class.getResource("/images/add.png")));
		...
		btnNewButton_2.setBounds(371, 314, 168, 30);
		panel_2.add(btnNewButton_2);
		
		JLabel lblNewLabel_14 = new JLabel("Status do Candidato:");
		lblNewLabel_14.setFont(new Font("Poppins", Font.PLAIN, 12));
		lblNewLabel_14.setBounds(22, 454, 130, 14);
		panel_2.add(lblNewLabel_14);
		
		JComboBox comStatus = new JComboBox();
		comStatus.setBackground(new Color(176, 224, 230));
		comStatus.setFont(new Font("Poppins", Font.PLAIN, 12));
		comStatus.setModel(new DefaultComboBoxModel(new String[] {"", "Participando", "Finalizado", "Aprovado"}));
		comStatus.setBounds(165, 449, 90, 25);
		panel_2.add(comStatus);
		
		JButton btnNewButton_3 = new JButton("Mudar Status");
		btnNewButton_3.setIcon(new ImageIcon(TelaCadastro.class.getResource("/images/refresh-page-option.png")));
		btnNewButton_3.setBackground(new Color(255, 153, 0));
		...
		btnNewButton_3.setBounds(371, 445, 168, 30);
		...
		btnNewButton_4.setIcon(new ImageIcon(TelaCadastro.class.getResource("/images/search.png")));
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(opcao >= 0) {
					...
					JOptionPane.showMessageDialog(null, "Selecione um candidato para visualizar! ");
				}
			}
		});
		btnNewButton_4.setBounds(371, 268, 250, 30);
		...
		btnLogOut.setBounds(789, 6, 130, 30);
		contentPane.add(btnLogOut);
		
		JLabel lblNome = new JLabel("");
		lblNome.setFont(new Font("Poppins", Font.BOLD, 14));
		...
		btnUsuarios.setBounds(718, 379, 130, 30);
		...
		lblNewLabel_10_1.setBounds(643, 62, 281, 14);
