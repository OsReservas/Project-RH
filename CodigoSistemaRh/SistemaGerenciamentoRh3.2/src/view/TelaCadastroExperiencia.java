...
public class TelaCadastroExperiencia extends JFrame {
	...
	private JTextField txtIdExperiencia;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					TelaCadastroExperiencia frame = new TelaCadastroExperiencia(u, candidato, experiencia);
	 ...
	 */
	public TelaCadastroExperiencia(Usuario u, Candidato candidato, Experiencia experiencia) throws ParseException {
		...
		panel_1.add(pnlProfissional);
				...
				lblNewLabel_36.setBounds(31, 222, 102, 14);
				pnlProfissional.add(lblNewLabel_36);
				
				JComboBox comAtuaEx = new JComboBox();
				comAtuaEx.setBackground(new Color(176, 224, 230));
				comAtuaEx.setFont(new Font("Poppins", Font.PLAIN, 12));
				comAtuaEx.setModel(new DefaultComboBoxModel(new String[] {"", "SIM\t", "NÃO"}));
				comAtuaEx.setBounds(137, 219, 55, 20);
				pnlProfissional.add(comAtuaEx);
				comAtuaEx.setSelectedItem(experiencia.getAtualEmprego());
				
				JLabel lblNewLabel_34 = new JLabel("Inicio: *");
				lblNewLabel_34.setFont(new Font("Poppins", Font.PLAIN, 12));
				lblNewLabel_34.setBounds(87, 181, 47, 14);
				...
				lblNewLabel_33.setBounds(58, 141, 75, 14);
				...
				txtSegmento.setText(experiencia.getSegmento());
				
				JLabel lblNewLabel_32 = new JLabel("Cargo: *");
				lblNewLabel_32.setFont(new Font("Poppins", Font.PLAIN, 12));
				lblNewLabel_32.setBounds(76, 101, 51, 14);
				pnlProfissional.add(lblNewLabel_32);
				
				txtIdExperiencia = new JTextField();
				txtIdExperiencia.setEditable(false);
				txtIdExperiencia.setBounds(342, 122, 86, 20);
				pnlProfissional.add(txtIdExperiencia);
				txtIdExperiencia.setColumns(10);
				txtIdExperiencia.setText(Integer.toString(experiencia.getIdexperiencia()));
				txtIdExperiencia.setVisible(false);
				...
				txtEmpresa.setText(experiencia.getEmpresa());
				...
				txtInicioP.setText(experiencia.getInicioExp());
				...
				txtTerminoP.setText(experiencia.getTerminoExp());
				...
				lblNewLabel_30.setBounds(248, 15, 180, 14);
				...
				btnAtualizar.setIcon(new ImageIcon(TelaCadastroExperiencia.class.getResource("/images/refresh-page-option.png")));
				...
				btnAtualizar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						experiencia.setIdexperiencia(Integer.parseInt(txtIdExperiencia.getText()));
						...
						experiencia.setAtualEmprego(comAtuaEx.getSelectedItem().toString());
						...
						txtInicioP.setText("");
						txtTerminoP.setText("");
						comAtuaEx.setSelectedIndex(0);
						txtDescricaoP.setText("");
						
						
					}
				});
				btnAtualizar.setBounds(511, 360, 135, 30);
				pnlProfissional.add(btnAtualizar);
				if(Integer.parseInt(txtIdExperiencia.getText()) == 0) {
				...
				btnNewButton_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						SelecionarExperiencia tela = new SelecionarExperiencia(u, candidato);
						tela.setVisible(true);
						dispose();
						
					}
				});
				btnNewButton_1.setBounds(511, 259, 70, 30);
				pnlProfissional.add(btnNewButton_1);
				...
				btnCadastarP.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						String atual = "Não";
						if(comAtuaEx.getSelectedItem() != null) {
							atual = comAtuaEx.getSelectedItem().toString();
						}
						experiencia.setAtualEmprego(atual);
		...
		JLabel lblNewLabel_21_1 = new JLabel("Passo 3 de 3");
