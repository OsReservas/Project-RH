...
public class TelaCadastroUsuario extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					TelaCadastroUsuario frame = new TelaCadastroUsuario(u);
	 ...
	 */
public void carregarUsuarioPorNome(String nome) {
		
		UsuarioDao usuariodao = new UsuarioDao();
		List <Usuario> lista = usuariodao.buscarUsuarioPorNome(nome);
	...
	public TelaCadastroUsuario(Usuario u) throws ParseException{
		...
		tabbedPane.addTab("Cadastro Usuario", null, panel, null);
		panel.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("ID:");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Poppins", Font.PLAIN, 12));
		lblNewLabel.setBounds(115, 47, 20, 15);
		...
		lblNewLabel_1.setBounds(29, 86, 112, 14);
		...
		lblNewLabel_2.setBounds(105, 127, 36, 14);
		...
		lblNewLabel_3.setBounds(99, 167, 46, 14);
		...
		lblNewLabel_4.setBounds(93, 207, 52, 14);
		...
		comAcesso.setBounds(145, 294, 72, 22);
		...
		lblAtivo.setBounds(52, 336, 93, 14);
		panel.add(lblAtivo);
		...
		comAtivo.setBounds(145, 332, 72, 22);
		panel.add(comAtivo);
		...
		JLabel lblNewLabel_11 = new JLabel("Confirme a senha: *");
		lblNewLabel_11.setFont(new Font("Poppins", Font.PLAIN, 12));
		lblNewLabel_11.setBounds(19, 245, 122, 14);
		panel.add(lblNewLabel_11);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBackground(Color.WHITE);
		tabbedPane.addTab("Gerenciamento de Usuario", null, panel_1, null);
		...
		txtNomeBusca.setFont(new Font("Poppins", Font.PLAIN, 12));
		txtNomeBusca.setBounds(66, 27, 431, 20);
		panel_1.add(txtNomeBusca);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				carregarUsuarioPorNome(txtNomeBusca.getText());
		...
		btnExcluir.setIcon(new ImageIcon(TelaCadastroUsuario.class.getResource("/images/deletar-lixeira.png")));
		...
		lblNewLabel_8.setBounds(718, 186, 135, 196);
		...
		lblNewLabel_7.setBounds(681, 150, 200, 25);
		...
		JButton btnNewButton = new JButton("Gerenciamento de Vagas");
		btnNewButton.setIcon(new ImageIcon(TelaCadastroUsuario.class.getResource("/images/gerenciamento-de-projetos.png")));
		...
		btnNewButton.setBounds(643, 393, 281, 30);
		contentPane.add(btnNewButton);
		
		JLabel lblNewLabel_10 = new JLabel("Usuario Logado");
		lblNewLabel_10.setFont(new Font("Poppins", Font.BOLD, 14));
		lblNewLabel_10.setBounds(718, 62, 119, 14);
		contentPane.add(lblNewLabel_10);
		
		JLabel lblNome = new JLabel("");
		lblNome.setHorizontalAlignment(SwingConstants.CENTER);
		lblNome.setFont(new Font("Poppins", Font.BOLD, 14));
		lblNome.setBounds(643, 90, 281, 14);
