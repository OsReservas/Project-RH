...
public class TelaVerVaga extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					TelaVerVaga frame = new TelaVerVaga(u);
	...
	public TelaVerVaga(Usuario u) throws ParseException {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaVerVaga.class.getResource("/images/iconimage.png")));
		...
		btnCadastrar.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/disk.png")));
		...
		btnAtualizar.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/refresh-page-option.png")));
		...
		btnCancelar.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/close.png")));
		...
		btnNewButton.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/search.png")));
		...
		btnNovo.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/add.png")));
		...
		btnEditar.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/editing.png")));
		...
		btnExcluir.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/deletar-lixeira.png")));
		...
		lblNewLabel_10.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/job-seeker.png")));
		lblNewLabel_10.setBounds(686, 170, 206, 198);
		contentPane.add(lblNewLabel_10);
		
		JLabel lblNewLabel_11 = new JLabel("");
		lblNewLabel_11.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_11.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/logo-one .png")));
		lblNewLabel_11.setBounds(643, 459, 281, 91);
		contentPane.add(lblNewLabel_11);
		
		JButton btnLogOut = new JButton("Sair");
		btnLogOut.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/logout.png")));
		...
		btnUsuarios.setIcon(new ImageIcon(TelaVerVaga.class.getResource("/images/user.png")));
