...
public class VagaDao {
	...
	public void cadastrarVaga(Vaga vaga) {
		...
		String sql = "INSERT INTO  vaga (titulo, cargo, formacao, periodo, regime, descricao, salario) VALUES (?, ?, ?, ?, ?, ?, ?)";
	...
	public void deletarVaga(Vaga vaga) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Esclusão da vaga cancelada! ");
		}
	}
