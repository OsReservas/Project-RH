...
public class UsuarioDao {
	...
	public void cadastrarUsuario(Usuario usuario) {
		...
		String sql = "INSERT INTO  usuario (nome, cpf, email, senha, acesso) VALUES (?, ?, ?, MD5 (?), ?)";
	...
	public void atualizarUsuario (Usuario usuario) {
		...
		String sql = "UPDATE usuario SET  nome = ?, cpf = ?, email = ?, senha = MD5 (?), acesso = ? " +
		"WHERE id = ?";
	...
	public void deletarUsuario(Usuario usuario) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Esclusão de usuario cancelada! ");
		}
	}
	...
	public List <Usuario> buscarUsuario(){
		...
		try {
			...
			while (rset.next()) {
				...
				usuario.setCpf(rset.getLong("cpf"));
	...
	public Usuario Loguin(String email, String senha) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Ocorreu um erro ao entrar no sitema! " + ex.getMessage());
