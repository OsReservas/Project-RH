...
public class TelaCadastro extends JFrame {
	...
	public TelaCadastro() {
		...
		txtDescricao.setFont(new Font("Poppins", Font.PLAIN, 12));
		...
		btnEditar.setBounds(248, 470, 110, 25);
		...
		btnExcluir.setBounds(460, 470, 110, 25);
		...
		btnLogOut.setBounds(727, 384, 110, 25);
