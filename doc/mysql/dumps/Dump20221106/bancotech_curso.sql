...
CREATE TABLE `curso` (
  ...
  `conclusao` varchar(15) DEFAULT NULL,
  `nivel` varchar(15) DEFAULT NULL,
  `idioma` varchar(30) DEFAULT NULL,
  `idcandidato` int DEFAULT NULL,
  PRIMARY KEY (`idcurso`),
  KEY `idcandidato` (`idcandidato`),
  CONSTRAINT `curso_ibfk_1` FOREIGN KEY (`idcandidato`) REFERENCES `candidato` (`idcandidato`)
...
-- Dump completed on 2022-11-06 12:16:41
