...
CREATE TABLE `aplicado` (
  ...
  `titulovaga` varchar(100) DEFAULT NULL,
  `andamento` varchar(50) DEFAULT NULL,
  `observacao` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idaplicado`),
  UNIQUE KEY `idcandidato` (`idcandidato`,`idvaga`),
  KEY `idvaga` (`idvaga`),
...
--
-- Dumping data for table `aplicado`
--

LOCK TABLES `aplicado` WRITE;
/*!40000 ALTER TABLE `aplicado` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplicado` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-27 13:15:44
